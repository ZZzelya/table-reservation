...
- [О проекте](#-о-проекте)
- [Ссылка на SonarCloud](#-sonarcloud-анализ)
- [Архитектура](#-архитектура-приложения)
- [REST API](#-rest-api-endpoints)
- [Структура проекта](#-структура-проекта)
- [Контроль качества](#-контроль-качества-кода)
- [Запуск приложения](#-запуск-приложения)
- [Чек-лист выполнения](#-чек-лист-лабораторной-работы)

---

## 📖 О ПРОЕКТЕ

Данный проект представляет собой REST API сервис для бронирования столиков в кафе. Разработан в рамках лабораторной работы по дисциплине *"Современные платформы разработки на языке Java"*.

**Цель работы:** Создать Spring Boot приложение с многослойной архитектурой (Controller → Service → Repository), реализовать REST endpoints с `@RequestParam` и `@PathVariable`, настроить Checkstyle и провести анализ кода через SonarCloud.
...
Приложение построено по классической многослойной архитектуре с четким разделением ответственности:
